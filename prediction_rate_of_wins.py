...
# -*- coding: utf-8 -*-
"""
Created on Sun May 23 20:23:54 2021
...
# 1:PLS, 2:Ridge, 3:Lasso, 4:Elastic net, 5:SVR_linear, 6:SVR_rbf, 7:RF, 8:GP の選択
regression_method = 3
...
#cvの実行と最良なハイパーパラメータでのモデル構築

if regression_method==1: # PLS
